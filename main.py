...
# ########################################################################################################################
#model = model_training(MODEL_TYPE, BACKBONE, LABEL_CLASSES_SUPERSTRUCTURES, DIR_SEGMENTATION_MODEL_DATA,
 #                      DIR_MASK_FILES, DIR_RESULTS_TRAINING, IMAGE_SHAPE)
...
dir_mask_files_test = os.path.join(DIR_SEGMENTATION_MODEL_DATA, 'filenames_train_val_test_split')
test_dataset = get_test_dataset(DATA_DIR_ANNOTATION_EXPERIMENT, dir_mask_files_test, '6_rev',
                                preprocess_input,
                                LABEL_CLASSES_SUPERSTRUCTURES.values())

filter_dataset = create_filter_dataset(DATA_DIR_ANNOTATION_EXPERIMENT, dir_mask_files_test, '6_rev',
